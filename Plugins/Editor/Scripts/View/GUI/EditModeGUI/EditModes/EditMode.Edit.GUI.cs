                ...
                GUILayout.BeginVertical(CSG_GUIStyleUtility.ContentEmpty);
                {
                    GUILayout.BeginVertical(CSG_GUIStyleUtility.ContentEmpty);
                    {
                        ...
                        GUILayout.BeginVertical(
                            ContentMeshLabel,
                            CSG_GUIStyleUtility.unpaddedWindow,
        ...
        )
        {
            bool operations_enabled =
                ...
                && (
                    ...
                    && filteredSelection.ModelTargets.Length == 0
                );
            ...
            GUILayout.BeginVertical(isSceneGUI ? InSceneWidth : CSG_GUIStyleUtility.ContentEmpty);
            {
                ...
                GUILayout.BeginVertical(isSceneGUI ? GUI.skin.box : GUIStyle.none);
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    {
                        GUILayout.BeginHorizontal(CSG_GUIStyleUtility.ContentEmpty);
                        {
                            selectionIgnoreBackfaced = GUILayout.Toggle(
                                selectionIgnoreBackfaced,
                                ContentIgnoreHidden,
                                button
                            );
                        ...
                        {
                            GUILayout.Label(
                                "No selection mode has been selected and nothing can be selected",
                                CSG_GUIStyleUtility.redTextArea
                            );
                        }
                        GUILayout.BeginHorizontal(CSG_GUIStyleUtility.ContentEmpty);
                        {
                            selectionVertex = GUILayout.Toggle(
                                selectionVertex,
                                ContentVertex,
                                button
                            );
                            ...
                            selectionSurface = GUILayout.Toggle(
                                selectionSurface,
                                ContentSurface,
                                button
                            );
                ...
                GUILayout.BeginVertical(isSceneGUI ? GUI.skin.box : GUIStyle.none);
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    {
                        autoCommitExtrusion = GUILayout.Toggle(
                            autoCommitExtrusion,
                            ContentAutoCommitExtrusion,
                            button
                        );
                ...
                GUILayout.BeginHorizontal(CSG_GUIStyleUtility.ContentEmpty);
                {
                    if (isSceneGUI)
                    {
                        ...
                        GUILayout.BeginVertical(CSG_GUIStyleUtility.ContentEmpty);
                        {
                            EditorGUI.BeginChangeCheck();
                            {
                                defaultMaterial = CSG_EditorGUIUtility.MaterialImage(
                                    defaultMaterial,
                                    small: true
                                );
                            }
                ...
                else
                {
                    ...
                    {
                        defaultMaterial =
                            EditorGUILayout.ObjectField(defaultMaterial, typeof(Material), true)
                            as Material;
                    }
                    if (EditorGUI.EndChangeCheck() && defaultMaterial)
                    {
