...
namespace RealtimeCSG
{
    ...
    {
        public GUIContent[] hierarchyOperations = new GUIContent[
            CSG_GUIStyleUtility.operationTypeCount
        ];
        ...
        public GUIContent[] operationNamesOn = new GUIContent[
            CSG_GUIStyleUtility.operationTypeCount
        ];
    ...
    internal static class CSG_GUIStyleUtility
    {
        ...
        public static ToolTip PopOutTooltip = new ToolTip(
            ...
            new KeyEvent(KeyCode.F2, EventModifiers.Control)
        );
        ...
        public static ToolTip[] operationTooltip = new ToolTip[]
        {
            new ToolTip(
                ...
                "Set the selection to be additive",
                Keys.MakeSelectedAdditiveKey
            ),
            new ToolTip(
                "Subtractive CSG operation",
                "Set the selection to be subtractive",
                Keys.MakeSelectedSubtractiveKey
            ),
            new ToolTip(
                "Intersecting CSG operation",
                "Set the selection to be an intersection operation",
                Keys.MakeSelectedIntersectingKey
            ),
        };
        ...
        public static readonly ToolTip passThroughTooltip = new ToolTip(
            "Perform no CSG operation",
            "No operation is performed. Child nodes act as if there is no operation above it. This is useful to group different kinds of nodes with.",
            Keys.MakeSelectedPassThroughKey
        );
        ...
        public static readonly ToolTip[] shapeModeTooltips = new ToolTip[shapeModeCount]
        {
            new ToolTip(
                "Free-draw brush",
                "Use this to draw a 2D shape and extrude it,\noptionally with curves by double clicking on edges.",
                Keys.FreeBuilderMode
            ),
            new ToolTip("Create Box brush", "Use this to create boxes", Keys.BoxBuilderMode),
            new ToolTip(
                "Create (Hemi)Sphere brush",
                "Use this to create (hemi)spheres",
                Keys.SphereBuilderMode
            ),
            new ToolTip(
                "Create Cylinder brush",
                "Use this to create cylinders",
                Keys.CylinderBuilderMode
            ),
            //new ToolTip("Create Spiral Stairs", "Use this to create spiral stairs", Keys.SpiralStairsBuilderMode),
            new ToolTip(
                "Create Linear Stairs",
                "Use this to create linear stairs",
                Keys.LinearStairsBuilderMode
            ),
        };
        ...
        public static readonly ToolTip[] clipTooltips = new ToolTip[]
        {
            new ToolTip(
                "Remove in front",
                "Remove the area in front of the created clipping plane from the selected brushes"
            ),
            new ToolTip(
                "Remove behind",
                "Remove the area behind the created clipping plane from the selected brushes"
            ),
        ...
        public static CSG_Skin Skin
        {
            get
            {
                return (EditorGUIUtility.isProSkin)
                    ? CSG_GUIStyleUtility.Pro
                    : CSG_GUIStyleUtility.Personal;
            }
        }
        ...
        public static void InitStyles()
        {
            ...
            emptyMaterialStyle.normal.background = MaterialUtility.CreateSolidColorTexture(
                2,
                2,
                Color.black
            );
            ...
            Pro.redToolbarDropDown.normal.textColor = Color.Lerp(
                Color.red,
                redToolbarDropDown.normal.textColor,
                0.5f
            );
            Pro.redToolbarDropDown.onNormal.textColor = Color.Lerp(
                Color.red,
                redToolbarDropDown.onNormal.textColor,
                0.125f
            );
            ...
            Personal.redToolbarDropDown.normal.textColor = Color.Lerp(
                Color.red,
                redToolbarDropDown.normal.textColor,
                0.5f
            );
            Personal.redToolbarDropDown.onNormal.textColor = Color.Lerp(
                Color.red,
                redToolbarDropDown.onNormal.textColor,
                0.125f
            );
            ...
            Pro.xToolbarButton.onNormal.textColor = Color.Lerp(
                Handles.xAxisColor,
                Color.white,
                0.125f
            );
            ...
            Pro.yToolbarButton.onNormal.textColor = Color.Lerp(
                Handles.yAxisColor,
                Color.white,
                0.125f
            );
            ...
            Pro.zToolbarButton.onNormal.textColor = Color.Lerp(
                Handles.zAxisColor,
                Color.white,
                0.125f
            );
            ...
            Personal.xToolbarButton.normal.textColor = Color.Lerp(
                Handles.xAxisColor,
                Color.white,
                0.75f
            );
            Personal.xToolbarButton.onNormal.textColor = Color.Lerp(
                Handles.xAxisColor,
                Color.black,
                0.25f
            );
            ...
            Personal.yToolbarButton.normal.textColor = Color.Lerp(
                Handles.yAxisColor,
                Color.white,
                0.75f
            );
            Personal.yToolbarButton.onNormal.textColor = Color.Lerp(
                Handles.yAxisColor,
                Color.black,
                0.25f
            );
            ...
            Personal.zToolbarButton.normal.textColor = Color.Lerp(
                Handles.zAxisColor,
                Color.white,
                0.75f
            );
            Personal.zToolbarButton.onNormal.textColor = Color.Lerp(
                Handles.zAxisColor,
                Color.black,
                0.25f
            );
            ...
            brushEditModeNames = (
                from name in System.Enum.GetNames(enum_type)
                select ObjectNames.NicifyVariableName(name)
            ).ToArray();
            ...
            for (int i = 0; i < operationTypeCount; i++)
            {
                ...
                personal_skin.operationNamesOn[i] = new GUIContent(
                    personalInActiveOperationTypes[i]
                );
                personal_skin.hierarchyOperations[i] = new GUIContent(
                    personalInActiveOperationTypes[i]
                );
