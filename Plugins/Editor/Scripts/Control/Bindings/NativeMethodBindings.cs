...
namespace RealtimeCSG
{
    ...
    public struct CSGSurfaceIntersection
    {
        ...
        public static readonly CSGSurfaceIntersection None = new CSGSurfaceIntersection()
        {
    ...
    public struct CSGTreeBrushIntersection
    {
        ...
        public static readonly CSGTreeBrushIntersection None = new CSGTreeBrushIntersection()
        {
    ...
    internal static class NativeMethodBindings
    {
        ...
        public delegate void StringLog(
            [MarshalAs(UnmanagedType.LPStr)] string text,
            int uniqueObjectID
        );

        [return: MarshalAs(UnmanagedType.LPStr)]
        public delegate string ReturnStringMethod(int uniqueObjectID);
        ...
        public static void RegisterUnityMethods()
        {
            ...
            {
                Debug.Log(message, NativeUserId.ToObject(uniqueObjectID));
            };
            unityMethods.DebugLogError = delegate(string message, int uniqueObjectID)
            {
                Debug.LogError(message, NativeUserId.ToObject(uniqueObjectID));
            };
            unityMethods.DebugLogWarning = delegate(string message, int uniqueObjectID)
            {
                Debug.LogWarning(message, NativeUserId.ToObject(uniqueObjectID));
            };
            unityMethods.NameForUserID = delegate(int uniqueObjectID)
            {
                var obj = NativeUserId.ToObject(uniqueObjectID);
                if (obj == null)
                    return "<unknown>";
                else
                    return obj.name;
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool DecomposeStart(
            Int32 vertexCount,
            [In] IntPtr vertices,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool DecomposeGetPolygon(
            Int32 polygonIndex,
            Int32 vertexSize,
            [Out] IntPtr vertices
        );
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool SetTreeEnabled(Int32 modelNodeID, bool isEnabled);

        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool RayCastMultiGet(
            int objectCount,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern Int32 RayCastIntoTreeMultiCount(
            Int32 modelNodeID,
        ...
        )
        {
            ...
            Int32 intersectionCount = RayCastIntoTreeMultiCount(
                model.modelNodeID,
                ref worldRayStart,
                ref worldRayEnd,
            ...
            GCHandle outputIntersectionsHandle = GCHandle.Alloc(
                __outputIntersections,
                GCHandleType.Pinned
            );
            ...
            {
                var obj = __outputIntersections[i].brushUserID.ToObject();
                ...
                var distance = (
                    __outputIntersections[i].intersection.worldIntersection - worldRayStart
                ).magnitude;

                intersectionList.Add(
                    new LegacyBrushIntersection
                    {
                        ...
                        surfaceIntersection = __outputIntersections[i]
                            .intersection
                            .surfaceIntersection,
        ...
        static readonly List<LegacyBrushIntersection> __intersectionList =
            new List<LegacyBrushIntersection>();
        ...
        )
        {
            ...
            for (int m = 0; m < modelCount; m++)
            {
                ...
                if (__prevIntersectionCount < intersectionCount)
                {
                    ...
                    __outputIntersections = new CSGTreeBrushIntersection[intersectionCount];
                    __prevIntersectionCount = intersectionCount;
                    outputIntersectionsHandle = GCHandle.Alloc(
                        __outputIntersections,
                        GCHandleType.Pinned
                    );
                }
                ...
                for (int i = 0, t = 0; i < intersectionCount; i++, t += 3)
                {
                    ...
                    var distance = (
                        __outputIntersections[i].intersection.worldIntersection - rayStart
                    ).magnitude;

                    __intersectionList.Add(
                        new LegacyBrushIntersection
                        {
                            gameObject = gameObject,
                            model = model,
                            ...
                            localPlane = new CSGPlane(
                                __outputIntersections[i].intersection.localPlane
                            ),
                            modelPlane = new CSGPlane(
                                __outputIntersections[i].intersection.modelPlane
                            ),
                            worldPlane = new CSGPlane(
                                __outputIntersections[i].intersection.worldPlane
                            ),
                            worldIntersection = __outputIntersections[i]
                                .intersection
                                .worldIntersection,
                            surfaceIntersection = __outputIntersections[i]
                                .intersection
            ...
            __intersectionList.Sort(
                delegate(LegacyBrushIntersection x, LegacyBrushIntersection y)
                {
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool RayCastIntoBrush(
            Int32 brushNodeID,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool RayCastIntoBrushSurface(
            Int32 brushNodeID,
            Int32 surfaceID,
            [In] ref Vector3 rayStart,
            [In] ref Vector3 rayEnd,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern int FindNodesInFrustum(
            Int32 modelNodeID,
            Int32 planeCount,
            [In] IntPtr planes
        );
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool RetrieveUserIDsInFrustum(
            Int32 objectIDCount,
        ...
        )
        {
            ...
            var itemCount = FindNodesInFrustum(
                model.modelNodeID,
                translated_planes.Length,
                planesPtr
            );
            planesHandle.Free();
            if (itemCount == 0)
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool SetChildNodes(
            Int32 nodeID,
            Int32 childCount,
            [In] IntPtr childrenNodeIDs
        );
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool SetBranchOperationType(
            Int32 operationNodeID,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool SetBrushOperationType(
            Int32 brushNodeID,
            CSGOperationType operation
        );

        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern Int32 CreateBrushMesh(
            Int32 userID,
            Int32 vertexCount,
            [In] IntPtr vertices,
            Int32 halfEdgeCount,
        ...
        private static Int32 CreateBrushMesh(Int32 userID, BrushMesh brushMesh)
        {
            ...
            if (
                brushMesh.vertices.Length < 5
                || brushMesh.halfEdges.Length < 16
                || brushMesh.polygons.Length < 5
            )
                return CSGNode.InvalidNodeID;
            ...
            var result = CreateBrushMesh(
                userID,
                brushMesh.vertices.Length,
                verticesPtr,
                brushMesh.halfEdges.Length,
                halfEdgesPtr,
                brushMesh.polygons.Length,
                polygonsPtr
            );
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool UpdateBrushMesh(
            Int32 brushMeshIndex,
            Int32 vertexCount,
            [In] IntPtr vertices,
            Int32 halfEdgeCount,
            [In] IntPtr halfEdges,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool SetNodeLocalTransformation(
            Int32 brushNodeID,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetSurfaceMinMaxTexCoords(
            Int32 brushNodeID,
            Int32 surfaceID,
            Matrix4x4 modelLocalToWorldMatrix,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool ConvertWorldToTextureCoord(
            Int32 brushNodeID,
            Int32 surfaceID,
            Matrix4x4 modelLocalToWorldMatrix,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool ConvertTextureToWorldCoord(
            Int32 brushNodeID,
            Int32 surfaceID,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GenerateMeshDescriptions(
            Int32 modelNodeID,
            Int32 meshTypeCount,
            [In] IntPtr meshTypes,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetMeshDescriptions(
            Int32 modelNodeID,
            Int32 meshDescriptionCount,
            [Out] IntPtr meshDescriptions
        );

        private static bool GetMeshDescriptions(
            Int32 modelNodeID,
        ...
        )
        {
            ...
            var result = GenerateMeshDescriptions(
                modelNodeID,
                meshTypes.Length,
                nativeMeshTypePtr,
                vertexChannelMask,
                out meshDescriptionCount
            );
        ...
        {
            return GetMeshDescriptions(
                model.modelNodeID,
                InternalCSGModelManager.GetMeshTypesForModel(model),
                model.VertexChannels,
                ref meshDescriptions
            );
        }

        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetGeneratedMesh(
            Int32 modelNodeID,
            Int32 meshIndex,
            Int32 subMeshIndex,
            Int32 indexCount,
        ...
        private static bool GetModelMesh(
            int modelNodeID,
            int meshIndex,
            int subMeshIndex,
            int indexCount,
        ...
        {
            if (
                (indices == null || indexCount > indices.Length)
                || // may not be null
                (positions == null || vertexCount > positions.Length)
                || // may not be null
                (tangents != null && vertexCount > tangents.Length)
                || // may be null
                (normals != null && vertexCount > normals.Length)
                || // may be null
                //				(colors    != null && vertexCount > colors   .Length) || // may be null
                (uv0 != null && vertexCount > uv0.Length)
            ) // may be null
            {
            ...
            if (tangents != null)
            {
                tangentHandle = GCHandle.Alloc(tangents, GCHandleType.Pinned);
                tangentPtr = tangentHandle.AddrOfPinnedObject();
            }
            if (normals != null)
            {
                normalHandle = GCHandle.Alloc(normals, GCHandleType.Pinned);
                normalPtr = normalHandle.AddrOfPinnedObject();
            }
            //			if (colors		!= null) { colorHandle		= GCHandle.Alloc(colors,	GCHandleType.Pinned); colorPtr	  = colorHandle.AddrOfPinnedObject(); }
            if (uv0 != null)
            {
                uv0Handle = GCHandle.Alloc(uv0, GCHandleType.Pinned);
                uv0Ptr = uv0Handle.AddrOfPinnedObject();
            }

            var result = GetGeneratedMesh(
                (Int32)modelNodeID,
                (Int32)meshIndex,
                (Int32)subMeshIndex,
                (Int32)indexCount,
        ...
        static GeneratedMeshContents GetModelMesh(
            int modelNodeID,
        ...
        )
        {
            ...
            generatedMesh.tangents =
                ((usedVertexChannels & VertexChannelFlags.Tangent) != 0)
                    ? new Vector4[vertexCount]
                    : null;
            generatedMesh.normals =
                ((usedVertexChannels & VertexChannelFlags.Normal) != 0)
                    ? new Vector3[vertexCount]
                    : null;
            generatedMesh.uv0 =
                ((usedVertexChannels & VertexChannelFlags.UV0) != 0)
        ...
        static bool GetModelMeshNoAlloc(
            int modelNodeID,
            GeneratedMeshDescription meshDescription,
            ref GeneratedMeshContents generatedMesh
        )
        {
            // create our arrays on the C# side with the correct size
            var usedVertexChannels = meshDescription.meshQuery.UsedVertexChannels;
            ...
            var normals =
                ((usedVertexChannels & VertexChannelFlags.Normal) != 0)
                    ...
                    : null;
            var uv0 =
                ((usedVertexChannels & VertexChannelFlags.UV0) != 0) ? generatedMesh.uv0 : null;
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetBrushOutlineSizes(
            Int32 brushNodeID,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetBrushOutlineValues(
            Int32 brushNodeID,
            Int32 vertexCount,
            [Out] IntPtr vertices,
        ...
        private static bool GetBrushOutline(Int32 brushNodeID, out GeometryWireframe outline)
        {
            int vertexCount = 0;
            ...
            if (
                ...
                && (
                    outline.visibleOuterLines == null
                    || outline.visibleOuterLines.Length != visibleOuterLineCount
                )
            )
            {
            ...
            if (
                ...
                && (
                    outline.visibleInnerLines == null
                    || outline.visibleInnerLines.Length != visibleInnerLineCount
                )
            )
            {
            ...
            if (
                ...
                && (
                    outline.invisibleOuterLines == null
                    || outline.invisibleOuterLines.Length != invisibleOuterLineCount
                )
            )
            {
            ...
            if (
                ...
                && (
                    outline.invisibleInnerLines == null
                    || outline.invisibleInnerLines.Length != invisibleInnerLineCount
                )
            )
            {
            ...
            GCHandle visibleOuterLinesHandle = GCHandle.Alloc(
                outline.visibleOuterLines,
                GCHandleType.Pinned
            );
            GCHandle visibleInnerLinesHandle = GCHandle.Alloc(
                outline.visibleInnerLines,
                GCHandleType.Pinned
            );
            GCHandle invisibleOuterLinesHandle = GCHandle.Alloc(
                outline.invisibleOuterLines,
                GCHandleType.Pinned
            );
            GCHandle invisibleInnerLinesHandle = GCHandle.Alloc(
                outline.invisibleInnerLines,
                GCHandleType.Pinned
            );
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetSurfaceOutlineSizes(
            Int32 brushNodeID,
            Int32 surfaceID,
            out Int32 vertexCount,
            out Int32 visibleOuterLineCount,
        ...
        [DllImport(NativePluginName, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetSurfaceOutlineValues(
            Int32 brushNodeID,
            Int32 surfaceID,
            Int32 vertexCount,
            [Out] IntPtr vertices,
        ...
        private static bool GetSurfaceOutline(
            Int32 brushNodeID,
            Int32 surfaceID,
        ...
        )
        {
            ...
            if (
                visibleTriangleCount > 0
                && (
                    outline.visibleTriangles == null
                    || outline.visibleTriangles.Length != visibleTriangleCount
                )
            )
            {
            ...
            GCHandle visibleTrianglesHandle = GCHandle.Alloc(
                outline.visibleTriangles,
                GCHandleType.Pinned
            );
            GCHandle invisibleOuterLinesHandle = GCHandle.Alloc(
                outline.invisibleOuterLines,
        ...
        public static void RegisterExternalMethods()
        {
            ...
            methods.DestroyNodes = delegate(Int32[] nodeIDs)
            {
                return DestroyNodes(nodeIDs.Length, nodeIDs);
            };
