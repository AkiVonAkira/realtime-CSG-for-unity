    ...
    internal sealed class UnityCompilerDefineManager
    {
        ...
        public static void UpdateUnityDefines()
        {
            ...
            foreach (var targetGroup in targetGroups)
            {
                ...
                var symbol_string = PlayerSettings.GetScriptingDefineSymbols(namedTarget);
#else
                ...
                bool modified = false;
                var symbols = symbol_string.Split(
                    new char[] { ';' },
                ...
                {
#if UNITY_2021_2_OR_NEWER
                    PlayerSettings.SetScriptingDefineSymbols(namedTarget, newSymbolString);
#else
