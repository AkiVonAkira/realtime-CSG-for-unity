...
namespace RealtimeCSG
{
    internal partial class InternalCSGModelManager
    {
        ...
        private static readonly Dictionary<Scene, CSGSceneState> SceneStates =
            new Dictionary<Scene, CSGSceneState>();
        ...
        static void InitializeDefaultCSGModel(
            Scene currentScene,
            CSGSceneState sceneState,
            bool createIfNoExists = true
        )
        {
            ...
            sceneState.DefaultModelObject =
                SceneQueryUtility.GetUniqueHiddenGameObjectInSceneWithName(
                    currentScene,
                    defaultModelName
                );
            if (createIfNoExists)
            {
                ...
                {
                    sceneState.DefaultModel =
                        sceneState.DefaultModelObject.GetComponent<CSGModel>();
                ...
                GameObjectUtility.SetStaticEditorFlags(
                    sceneState.DefaultModel.gameObject,
                    defaultFlags
                );
            ...
            if (inPrefabMode)
                sceneState.DefaultModelObject.hideFlags =
                    MeshInstanceManager.ComponentHideFlags | HideFlags.DontSave;
            else
